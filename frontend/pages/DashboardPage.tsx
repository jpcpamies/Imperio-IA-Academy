            ...
            <CardContent className="p-6">
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">Completed "Machine Learning Basics"</p>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">Started "Types of AI Systems"</p>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">Enrolled in "AI Fundamentals for Professionals"</p>
