...
```bash
git remote add encore encore://ai-learning-management-system-iowi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/ai-learning-management-system-iowi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/ai-learning-management-system-iowi/settings/integrations/github)
